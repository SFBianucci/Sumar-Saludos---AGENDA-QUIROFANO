  ...
  return (
    <div className={`inline-flex items-center justify-center ${className}`}>
      ...
      >
        ...
        <defs>
          <linearGradient id="paint0_linear_desktop" x1="37.7616" y1="112.291" x2="68.9038" y2="75.3661" gradientUnits="userSpaceOnUse">
            <stop stopColor="#00BDFB"/>
            <stop offset="1" stopColor="#0053C5"/>
          </linearGradient>
          <linearGradient id="paint1_linear_desktop" x1="101.322" y1="48.2265" x2="47.3878" y2="96.1677" gradientUnits="userSpaceOnUse">
